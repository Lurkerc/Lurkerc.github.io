self.$config = {
    nav: [
        ...
        { title: 'ECMAScript', path: '/es', source: 'https://raw.githubusercontent.com/Lurkerc/codeSpec/master/es.md' },
        { title: 'E-Json', path: '/e-json', source: 'https://raw.githubusercontent.com/Lurkerc/codeSpec/master/e-json.md' },
        { title: '模块和加载器', path: '/module', source: 'https://raw.githubusercontent.com/Lurkerc/codeSpec/master/module.md' }
    ],
    icons: [{
        icon: 'github',
        label: 'Contribute on GitHub',
        link: 'https://github.com/Lurkerc/codeSpec'
    }]
}